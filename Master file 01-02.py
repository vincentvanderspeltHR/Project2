...
def do_action(action):
    ...
    if action == "high score":
        ...
        global card_draw_sound
        global attack_sound
        global play_card_sound
        global buff_card_sound
        global ship_movement
        global button_click
        pygame.mixer.music.load("Epic sax guy 10 hours.wav")
...
def gameSettings():
    ...
    while settings_pause:
        ...
        if Game1.sound is True:
            sound_off_function(screen, display_width / 2 - (sound_off_width / 2) + 150,
                               display_height / 2 - (sound_off_height / 2))
