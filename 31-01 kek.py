...
def gameRules(page):
    ...
    while not gameExit:
        ...
        if page == "main":
            ...
            text_to_screen("Welkom op pagina kaarten", black, -225, "small", -100)
            text_to_screen("Er zijn 3 verschillende stapels kaarten in het spel: de basisstapel, speciale stapel", black, -175, "rules", -100)
            text_to_screen("en de weggooistapel. In de basisstapel zitten alle offensieve, defensieve en hulpkaarten.", black, -125, "rules", -100)
            text_to_screen("In de speciale stapel zitten zoals de naam al zegt alle speciale kaarten. Speciale kaarten", black, -75, "rules", -100)
            text_to_screen("zijn meestal pernamente buffs. Alle kaarten die al zijn gebruikt gaan naar de weggooistapel.", black, -25, "rules", -100)
             ...
             if event.type == pygame.QUIT:
                 ...
                 if not attacking:
                     if event.key == pygame.K_RIGHT:
                         ...
                         Game1.currentplayer.cards_in_hand.append(card_aluminium_hull)
                         pygame.mixer.Sound.play(card_draw_sound)
                     if not setup:
